...
const createStyles = (colors: any) => StyleSheet.create({
  ...
  fechaBox: {
    ...
    height: 60,
    borderRadius: 10,
    backgroundColor: 'rgba(105,182,230,0.16)',
    alignItems: 'center',
    justifyContent: 'center',
  },
  fechaDia: { color: '#1562A2', fontSize: 11, fontWeight: '700', textTransform: 'uppercase' },
  fechaNumero: { color: '#69B6E6', fontSize: 20, fontWeight: '800', lineHeight: 24 },
  fechaMes: { color: '#1562A2', fontSize: 11, fontWeight: '600', textTransform: 'uppercase' },
  info: { flex: 1, gap: 4 },
  titulo: { color: colors.text, fontSize: 15, fontWeight: '700', fontFamily: 'Gilroy-Bold' },
