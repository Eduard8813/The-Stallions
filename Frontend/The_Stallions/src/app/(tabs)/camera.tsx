        ...
        {showConfirm && (
          <View style={styles.modalContainer}>
            ...
            <View style={styles.modalButtons}>
              <TouchableOpacity title="Cancelar" onPress={() => setShowConfirm(false)} style={styles.modalButton} />
              <TouchableOpacity title="Subir" onPress={confirmUpload} style={styles.modalButton} color="#e40077" />
            </View>
          </View>
        )}
      </View>
