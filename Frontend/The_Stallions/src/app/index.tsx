...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, fontWeight: '800', fontFamily: 'Gilroy-Bold', color: '#fff', marginBottom: 6 },
  subtitle: { fontSize: 14, fontFamily: 'Gilroy-Medium', color: '#94a3b8', textAlign: 'center', marginBottom: 22 },
